    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-2xl p-8 text-white mb-8 animate-slide-down shadow-xl">
        ...
        <button
          ...
          className="bg-white text-primary-600 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 hover:scale-105 active:scale-95 transition-all duration-200 flex items-center space-x-2 min-h-[56px] shadow-lg"
        >
